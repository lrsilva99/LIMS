...
public class Tbc_grupo_analiseResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_grupo_analiseResource tbc_grupo_analiseResource = new Tbc_grupo_analiseResource(tbc_grupo_analiseService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_grupo_analise.class);
    }
}
