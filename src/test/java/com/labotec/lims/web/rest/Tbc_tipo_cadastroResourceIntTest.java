...
public class Tbc_tipo_cadastroResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_tipo_cadastroResource tbc_tipo_cadastroResource = new Tbc_tipo_cadastroResource(tbc_tipo_cadastroService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_tipo_cadastro.class);
    }
}
