...
public class Tbc_relatorio_ensaioResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_relatorio_ensaioResource tbc_relatorio_ensaioResource = new Tbc_relatorio_ensaioResource(tbc_relatorio_ensaioService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_relatorio_ensaio.class);
    }
}
