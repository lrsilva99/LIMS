...
import static com.labotec.lims.web.rest.TestUtil.sameInstant;
...
public class Tbc_analisesResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_analisesResource tbc_analisesResource = new Tbc_analisesResource(tbc_analisesService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_analises.class);
    }
}
