...
public class Tbc_grupo_clienteResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_grupo_clienteResource tbc_grupo_clienteResource = new Tbc_grupo_clienteResource(tbc_grupo_clienteService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_grupo_cliente.class);
    }
}
