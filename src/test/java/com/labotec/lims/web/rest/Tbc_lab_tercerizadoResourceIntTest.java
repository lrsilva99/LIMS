...
public class Tbc_lab_tercerizadoResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_lab_tercerizadoResource tbc_lab_tercerizadoResource = new Tbc_lab_tercerizadoResource(tbc_lab_tercerizadoService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_lab_tercerizado.class);
    }
}
