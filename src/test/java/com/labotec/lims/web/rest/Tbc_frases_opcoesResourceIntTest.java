...
public class Tbc_frases_opcoesResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_frases_opcoesResource tbc_frases_opcoesResource = new Tbc_frases_opcoesResource(tbc_frases_opcoesService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_frases_opcoes.class);
    }
}
