...
public class Tbc_analises_componenteResourceIntTest {
    ...
    public void setup() {
        ...
        Tbc_analises_componenteResource tbc_analises_componenteResource = new Tbc_analises_componenteResource(tbc_analises_componenteService);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(Tbc_analises_componente.class);
    }
}
