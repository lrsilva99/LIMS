...
public class Tbc_sub_grupoResource {
    ...
    private static final String ENTITY_NAME = "tbc_sub_grupo";
        
    private final Tbc_sub_grupoService tbc_sub_grupoService;

    public Tbc_sub_grupoResource(Tbc_sub_grupoService tbc_sub_grupoService) {
    ...
    public ResponseEntity<Tbc_sub_grupo> createTbc_sub_grupo(@Valid @RequestBody Tbc_sub_grupo tbc_sub_grupo) throws URISyntaxException {
        ...
        if (tbc_sub_grupo.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_sub_grupo cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_sub_grupo> updateTbc_sub_grupo(@Valid @RequestBody Tbc_sub_grupo tbc_sub_grupo) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_sub_grupo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_sub_grupo> getTbc_sub_grupo(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_sub_grupo));
    }
