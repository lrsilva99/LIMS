...
public class Tbc_tipo_campoResource {
    ...
    private static final String ENTITY_NAME = "tbc_tipo_campo";
        
    private final Tbc_tipo_campoService tbc_tipo_campoService;

    public Tbc_tipo_campoResource(Tbc_tipo_campoService tbc_tipo_campoService) {
    ...
    public ResponseEntity<Tbc_tipo_campo> createTbc_tipo_campo(@Valid @RequestBody Tbc_tipo_campo tbc_tipo_campo) throws URISyntaxException {
        ...
        if (tbc_tipo_campo.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_tipo_campo cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_tipo_campo> updateTbc_tipo_campo(@Valid @RequestBody Tbc_tipo_campo tbc_tipo_campo) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_tipo_campo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_tipo_campo> getTbc_tipo_campo(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_tipo_campo));
    }
