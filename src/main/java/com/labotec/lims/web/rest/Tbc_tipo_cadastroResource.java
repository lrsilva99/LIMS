...
public class Tbc_tipo_cadastroResource {
    ...
    private static final String ENTITY_NAME = "tbc_tipo_cadastro";
        
    private final Tbc_tipo_cadastroService tbc_tipo_cadastroService;

    public Tbc_tipo_cadastroResource(Tbc_tipo_cadastroService tbc_tipo_cadastroService) {
    ...
    public ResponseEntity<Tbc_tipo_cadastro> createTbc_tipo_cadastro(@Valid @RequestBody Tbc_tipo_cadastro tbc_tipo_cadastro) throws URISyntaxException {
        ...
        if (tbc_tipo_cadastro.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_tipo_cadastro cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_tipo_cadastro> updateTbc_tipo_cadastro(@Valid @RequestBody Tbc_tipo_cadastro tbc_tipo_cadastro) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_tipo_cadastro.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_tipo_cadastro> getTbc_tipo_cadastro(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_tipo_cadastro));
    }
