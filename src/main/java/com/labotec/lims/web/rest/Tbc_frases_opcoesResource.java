...
public class Tbc_frases_opcoesResource {
    ...
    private static final String ENTITY_NAME = "tbc_frases_opcoes";
        
    private final Tbc_frases_opcoesService tbc_frases_opcoesService;

    public Tbc_frases_opcoesResource(Tbc_frases_opcoesService tbc_frases_opcoesService) {
    ...
    public ResponseEntity<Tbc_frases_opcoes> createTbc_frases_opcoes(@Valid @RequestBody Tbc_frases_opcoes tbc_frases_opcoes) throws URISyntaxException {
        ...
        if (tbc_frases_opcoes.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_frases_opcoes cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_frases_opcoes> updateTbc_frases_opcoes(@Valid @RequestBody Tbc_frases_opcoes tbc_frases_opcoes) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_frases_opcoes.getId().toString()))
            .body(result);
    }
    ...
    @Timed
    public ResponseEntity<List<Tbc_frases_opcoes>> getAllTbc_frases_opcoes(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Tbc_frases_opcoes");
        Page<Tbc_frases_opcoes> page = tbc_frases_opcoesService.findAll(pageable);
    ...
    public ResponseEntity<Tbc_frases_opcoes> getTbc_frases_opcoes(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_frases_opcoes));
    }
