...
public class Tbc_instituicaoResource {
    ...
    private static final String ENTITY_NAME = "tbc_instituicao";
        
    private final Tbc_instituicaoService tbc_instituicaoService;

    public Tbc_instituicaoResource(Tbc_instituicaoService tbc_instituicaoService) {
    ...
    public ResponseEntity<Tbc_instituicao> createTbc_instituicao(@Valid @RequestBody Tbc_instituicao tbc_instituicao) throws URISyntaxException {
        ...
        if (tbc_instituicao.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_instituicao cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_instituicao> updateTbc_instituicao(@Valid @RequestBody Tbc_instituicao tbc_instituicao) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_instituicao.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_instituicao> getTbc_instituicao(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_instituicao));
    }
