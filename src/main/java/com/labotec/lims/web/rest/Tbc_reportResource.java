...
public class Tbc_reportResource {
    ...
    private static final String ENTITY_NAME = "tbc_report";
        
    private final Tbc_reportService tbc_reportService;

    public Tbc_reportResource(Tbc_reportService tbc_reportService) {
    ...
    public ResponseEntity<Tbc_report> createTbc_report(@Valid @RequestBody Tbc_report tbc_report) throws URISyntaxException {
        ...
        if (tbc_report.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_report cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_report> updateTbc_report(@Valid @RequestBody Tbc_report tbc_report) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_report.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_report> getTbc_report(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_report));
    }
