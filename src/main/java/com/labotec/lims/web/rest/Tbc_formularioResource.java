...
public class Tbc_formularioResource {
    ...
    private static final String ENTITY_NAME = "tbc_formulario";
        
    private final Tbc_formularioService tbc_formularioService;

    public Tbc_formularioResource(Tbc_formularioService tbc_formularioService) {
    ...
    public ResponseEntity<Tbc_formulario> createTbc_formulario(@Valid @RequestBody Tbc_formulario tbc_formulario) throws URISyntaxException {
        ...
        if (tbc_formulario.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_formulario cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_formulario> updateTbc_formulario(@Valid @RequestBody Tbc_formulario tbc_formulario) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_formulario.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_formulario> getTbc_formulario(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_formulario));
    }
