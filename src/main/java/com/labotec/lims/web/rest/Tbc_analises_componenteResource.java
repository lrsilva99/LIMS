...
import com.labotec.lims.web.rest.util.HeaderUtil;
import com.labotec.lims.web.rest.util.PaginationUtil;
...
public class Tbc_analises_componenteResource {
    ...
    private static final String ENTITY_NAME = "tbc_analises_componente";
        
    private final Tbc_analises_componenteService tbc_analises_componenteService;

    public Tbc_analises_componenteResource(Tbc_analises_componenteService tbc_analises_componenteService) {
    ...
    public ResponseEntity<Tbc_analises_componente> createTbc_analises_componente(@Valid @RequestBody Tbc_analises_componente tbc_analises_componente) throws URISyntaxException {
        ...
        if (tbc_analises_componente.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_analises_componente cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_analises_componente> updateTbc_analises_componente(@Valid @RequestBody Tbc_analises_componente tbc_analises_componente) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_analises_componente.getId().toString()))
            .body(result);
    }
    ...
    @Timed
    public ResponseEntity<List<Tbc_analises_componente>> getAllTbc_analises_componentes(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Tbc_analises_componentes");
        Page<Tbc_analises_componente> page = tbc_analises_componenteService.findAll(pageable);
    ...
    public ResponseEntity<Tbc_analises_componente> getTbc_analises_componente(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_analises_componente));
    }
