...
import com.labotec.lims.service.Tbc_relatorio_ensaioService;
...
public class Tbc_relatorio_ensaioResource {
    ...
    private static final String ENTITY_NAME = "tbc_relatorio_ensaio";
        
    private final Tbc_relatorio_ensaioService tbc_relatorio_ensaioService;

    public Tbc_relatorio_ensaioResource(Tbc_relatorio_ensaioService tbc_relatorio_ensaioService) {
    ...
    public ResponseEntity<Tbc_relatorio_ensaio> createTbc_relatorio_ensaio(@Valid @RequestBody Tbc_relatorio_ensaio tbc_relatorio_ensaio) throws URISyntaxException {
        ...
        if (tbc_relatorio_ensaio.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_relatorio_ensaio cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_relatorio_ensaio> updateTbc_relatorio_ensaio(@Valid @RequestBody Tbc_relatorio_ensaio tbc_relatorio_ensaio) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_relatorio_ensaio.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_relatorio_ensaio> getTbc_relatorio_ensaio(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_relatorio_ensaio));
    }
