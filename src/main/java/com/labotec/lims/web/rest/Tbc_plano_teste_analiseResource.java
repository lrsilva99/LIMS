...
public class Tbc_plano_teste_analiseResource {
    ...
    private static final String ENTITY_NAME = "tbc_plano_teste_analise";
        
    private final Tbc_plano_teste_analiseService tbc_plano_teste_analiseService;

    public Tbc_plano_teste_analiseResource(Tbc_plano_teste_analiseService tbc_plano_teste_analiseService) {
    ...
    public ResponseEntity<Tbc_plano_teste_analise> createTbc_plano_teste_analise(@Valid @RequestBody Tbc_plano_teste_analise tbc_plano_teste_analise) throws URISyntaxException {
        ...
        if (tbc_plano_teste_analise.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_plano_teste_analise cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_plano_teste_analise> updateTbc_plano_teste_analise(@Valid @RequestBody Tbc_plano_teste_analise tbc_plano_teste_analise) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_plano_teste_analise.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_plano_teste_analise> getTbc_plano_teste_analise(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_plano_teste_analise));
    }
