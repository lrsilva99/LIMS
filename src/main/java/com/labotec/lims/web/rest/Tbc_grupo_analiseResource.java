...
public class Tbc_grupo_analiseResource {
    ...
    private static final String ENTITY_NAME = "tbc_grupo_analise";
        
    private final Tbc_grupo_analiseService tbc_grupo_analiseService;

    public Tbc_grupo_analiseResource(Tbc_grupo_analiseService tbc_grupo_analiseService) {
    ...
    public ResponseEntity<Tbc_grupo_analise> createTbc_grupo_analise(@Valid @RequestBody Tbc_grupo_analise tbc_grupo_analise) throws URISyntaxException {
        ...
        if (tbc_grupo_analise.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_grupo_analise cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_grupo_analise> updateTbc_grupo_analise(@Valid @RequestBody Tbc_grupo_analise tbc_grupo_analise) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_grupo_analise.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_grupo_analise> getTbc_grupo_analise(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_grupo_analise));
    }
