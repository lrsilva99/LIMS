...
public class Tbc_lab_tercerizadoResource {
    ...
    private static final String ENTITY_NAME = "tbc_lab_tercerizado";
        
    private final Tbc_lab_tercerizadoService tbc_lab_tercerizadoService;

    public Tbc_lab_tercerizadoResource(Tbc_lab_tercerizadoService tbc_lab_tercerizadoService) {
    ...
    public ResponseEntity<Tbc_lab_tercerizado> createTbc_lab_tercerizado(@Valid @RequestBody Tbc_lab_tercerizado tbc_lab_tercerizado) throws URISyntaxException {
        ...
        if (tbc_lab_tercerizado.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_lab_tercerizado cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_lab_tercerizado> updateTbc_lab_tercerizado(@Valid @RequestBody Tbc_lab_tercerizado tbc_lab_tercerizado) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_lab_tercerizado.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_lab_tercerizado> getTbc_lab_tercerizado(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_lab_tercerizado));
    }
