...
public class Tbc_analisesResource {
    ...
    private static final String ENTITY_NAME = "tbc_analises";
        
    private final Tbc_analisesService tbc_analisesService;

    public Tbc_analisesResource(Tbc_analisesService tbc_analisesService) {
    ...
    public ResponseEntity<Tbc_analises> createTbc_analises(@Valid @RequestBody Tbc_analises tbc_analises) throws URISyntaxException {
        ...
        if (tbc_analises.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_analises cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_analises> updateTbc_analises(@Valid @RequestBody Tbc_analises tbc_analises) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_analises.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_analises> getTbc_analises(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_analises));
    }
    ...
    public ResponseEntity<List<Tbc_analises>> searchTbc_analises(@RequestParam String query, @ApiParam Pageable pageable)
        ...
        Page<Tbc_analises> page = tbc_analisesService.search(query, pageable);
