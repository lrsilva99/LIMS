...
public class Tbc_clienteResource {
    ...
    private static final String ENTITY_NAME = "tbc_cliente";
        
    private final Tbc_clienteService tbc_clienteService;

    public Tbc_clienteResource(Tbc_clienteService tbc_clienteService) {
    ...
    public ResponseEntity<Tbc_cliente> createTbc_cliente(@Valid @RequestBody Tbc_cliente tbc_cliente) throws URISyntaxException {
        ...
        if (tbc_cliente.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_cliente cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_cliente> updateTbc_cliente(@Valid @RequestBody Tbc_cliente tbc_cliente) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_cliente.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_cliente> getTbc_cliente(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_cliente));
    }
