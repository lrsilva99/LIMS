...
public class Tbc_frasesResource {
    ...
    private static final String ENTITY_NAME = "tbc_frases";
        
    private final Tbc_frasesService tbc_frasesService;

    public Tbc_frasesResource(Tbc_frasesService tbc_frasesService) {
    ...
    public ResponseEntity<Tbc_frases> createTbc_frases(@Valid @RequestBody Tbc_frases tbc_frases) throws URISyntaxException {
        ...
        if (tbc_frases.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new tbc_frases cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Tbc_frases> updateTbc_frases(@Valid @RequestBody Tbc_frases tbc_frases) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, tbc_frases.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tbc_frases> getTbc_frases(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(tbc_frases));
    }
