...
import com.labotec.lims.repository.Tbc_relatorio_ensaioRepository;
import com.labotec.lims.repository.search.Tbc_relatorio_ensaioSearchRepository;
...
public class Tbc_relatorio_ensaioServiceImpl implements Tbc_relatorio_ensaioService{
    ...
    private final Tbc_relatorio_ensaioRepository tbc_relatorio_ensaioRepository;

    private final Tbc_relatorio_ensaioSearchRepository tbc_relatorio_ensaioSearchRepository;

    public Tbc_relatorio_ensaioServiceImpl(Tbc_relatorio_ensaioRepository tbc_relatorio_ensaioRepository, Tbc_relatorio_ensaioSearchRepository tbc_relatorio_ensaioSearchRepository) {
        this.tbc_relatorio_ensaioRepository = tbc_relatorio_ensaioRepository;
        this.tbc_relatorio_ensaioSearchRepository = tbc_relatorio_ensaioSearchRepository;
    }
