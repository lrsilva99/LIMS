...
@Component({
    ...
    templateUrl: './tbc-relatorio-ensaio.component.html'
})
export class Tbc_relatorio_ensaioComponent implements OnInit, OnDestroy {

currentAccount: any;
    tbc_relatorio_ensaios: Tbc_relatorio_ensaio[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Tbc_relatorio_ensaio) {
        return item.id;
    }
    ...
    registerChangeInTbc_relatorio_ensaios() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_relatorio_ensaioListModification', (response) => this.loadAll());
    }
