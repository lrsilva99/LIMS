...
@Component({
    ...
    templateUrl: './tbc-instituicao.component.html'
})
export class Tbc_instituicaoComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_instituicao) {
        return item.id;
    }



    registerChangeInTbc_instituicaos() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_instituicaoListModification', (response) => this.loadAll());
    }
