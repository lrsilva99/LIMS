...
@Component({
    ...
    templateUrl: './tbc-grupo-analise.component.html'
})
export class Tbc_grupo_analiseComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_grupo_analise) {
        return item.id;
    }



    registerChangeInTbc_grupo_analises() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_grupo_analiseListModification', (response) => this.loadAll());
    }
