...
@Component({
    ...
    templateUrl: './tbc-tipo-cadastro.component.html'
})
export class Tbc_tipo_cadastroComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_tipo_cadastro) {
        return item.id;
    }



    registerChangeInTbc_tipo_cadastros() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_tipo_cadastroListModification', (response) => this.loadAll());
    }
