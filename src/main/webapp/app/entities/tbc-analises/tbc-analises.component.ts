...
@Component({
    ...
    templateUrl: './tbc-analises.component.html'
})
export class Tbc_analisesComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_analises) {
        return item.id;
    }
    ...
    registerChangeInTbc_analises() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_analisesListModification', (response) => this.loadAll());
    }
