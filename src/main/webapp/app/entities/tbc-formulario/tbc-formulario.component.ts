...
@Component({
    ...
    templateUrl: './tbc-formulario.component.html'
})
export class Tbc_formularioComponent implements OnInit, OnDestroy {

currentAccount: any;
    tbc_formularios: Tbc_formulario[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Tbc_formulario) {
        return item.id;
    }



    registerChangeInTbc_formularios() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_formularioListModification', (response) => this.loadAll());
    }
