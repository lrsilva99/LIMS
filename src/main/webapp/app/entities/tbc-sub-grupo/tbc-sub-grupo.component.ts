...
@Component({
    ...
    templateUrl: './tbc-sub-grupo.component.html'
})
export class Tbc_sub_grupoComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_sub_grupo) {
        return item.id;
    }



    registerChangeInTbc_sub_grupos() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_sub_grupoListModification', (response) => this.loadAll());
    }
