...
@Component({
    ...
    templateUrl: './tbc-analises-componente.component.html'
})
export class Tbc_analises_componenteComponent implements OnInit, OnDestroy {

currentAccount: any;
    tbc_analises_componentes: Tbc_analises_componente[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Tbc_analises_componente) {
        return item.id;
    }
    ...
    registerChangeInTbc_analises_componentes() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_analises_componenteListModification', (response) => this.loadAll());
    }
