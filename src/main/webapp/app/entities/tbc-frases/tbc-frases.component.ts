...
@Component({
    ...
    templateUrl: './tbc-frases.component.html'
})
export class Tbc_frasesComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_frases) {
        return item.id;
    }



    registerChangeInTbc_frases() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_frasesListModification', (response) => this.loadAll());
    }
