...
@Component({
    ...
    templateUrl: './tbc-tipo-campo.component.html'
})
export class Tbc_tipo_campoComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_tipo_campo) {
        return item.id;
    }



    registerChangeInTbc_tipo_campos() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_tipo_campoListModification', (response) => this.loadAll());
    }
