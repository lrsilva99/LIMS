...
@Component({
    ...
    templateUrl: './tbc-lab-tercerizado.component.html'
})
export class Tbc_lab_tercerizadoComponent implements OnInit, OnDestroy {

currentAccount: any;
    tbc_lab_tercerizados: Tbc_lab_tercerizado[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Tbc_lab_tercerizado) {
        return item.id;
    }
    ...
    registerChangeInTbc_lab_tercerizados() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_lab_tercerizadoListModification', (response) => this.loadAll());
    }
