...
@Component({
    ...
    templateUrl: './tbc-frases-opcoes.component.html'
})
export class Tbc_frases_opcoesComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_frases_opcoes) {
        return item.id;
    }



    registerChangeInTbc_frases_opcoes() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_frases_opcoesListModification', (response) => this.loadAll());
    }
