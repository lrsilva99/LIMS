...
@Component({
    ...
    templateUrl: './tbc-plano-teste.component.html'
})
export class Tbc_plano_testeComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId (index: number, item: Tbc_plano_teste) {
        return item.id;
    }
    ...
    registerChangeInTbc_plano_testes() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_plano_testeListModification', (response) => this.loadAll());
    }
