...
@Component({
    ...
    templateUrl: './tbc-cliente.component.html'
})
export class Tbc_clienteComponent implements OnInit, OnDestroy {

currentAccount: any;
    tbc_clientes: Tbc_cliente[];
    error: any;
    success: any;
    ...
    trackId (index: number, item: Tbc_cliente) {
        return item.id;
    }
    ...
    registerChangeInTbc_clientes() {
        this.eventSubscriber = this.eventManager.subscribe('tbc_clienteListModification', (response) => this.loadAll());
    }
